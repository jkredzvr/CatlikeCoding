...
public class BezierSpline : MonoBehaviour {
    ...
    public void AddCurve() {
        //Get last point in the array
        Vector3 point = points[points.Length - 1];
        //Add 3 more indices to the points array
        Array.Resize(ref points, points.Length + 3);
        //increment the x position by 1
        point.x += 1f;
        //1st new indice gets updated point
        points[points.Length - 3] = point;
        //increment x position again
        point.x += 1f;
        //2nd new indce gets new updated point...
    ...
    public Vector3 GetPoint(float t)
    {
        ...
        {
            //extrapolate the float based on the # of curves.  .2 lerp on 3 splines....
